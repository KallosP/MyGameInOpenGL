...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "MyOpenGLGame", NULL, NULL);
    if (window == NULL) {
	...
	Material* material = new Material("source.gif");
	Material* mask = new Material("water.gif");
